...
import defaultImg from "@/assets/sea-view.avif";
import { targetAudienceContent as defaultContent } from "@/data/home/targetAudienceData";
...
export default function TargetAudience({
  ...
  return (
    <section className="py-24 md:py-32 bg-white" id="target-audience">
          ...
          >
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border-2 border-slate-200 text-slate-700 font-semibold text-sm hover:border-brand-400 hover:text-brand-600 transition-all"
              >
