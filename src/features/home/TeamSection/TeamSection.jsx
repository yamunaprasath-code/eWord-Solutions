...
import defaultImg from "@/assets/Team Photo - homepage.jpeg";
import { teamContent as defaultContent } from "@/data/home/teamData";
...
export default function TeamSection({
  ...
  return (
    <section className="py-24 md:py-32 bg-[#d9ecff8a]" id="team">
